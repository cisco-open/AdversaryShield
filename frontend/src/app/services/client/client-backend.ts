		...
		return of(serviceCall).pipe(
			switchMap((call) => {
				switch (call.getMethod) {
					case 'GET':
						return this.httpClient.get<Response>(call.getUrl, this.getRequestOptions(call));
					case 'POST':
						return this.httpClient.post<Response>(call.getUrl, call.getBody, this.getRequestOptions(call));
					case 'PUT':
						return this.httpClient.put<Response>(call.getUrl, call.getBody, this.getRequestOptions(call));
					case 'DELETE':
						return this.httpClient.delete<Response>(call.getUrl, this.getRequestOptions(call));
					default:
