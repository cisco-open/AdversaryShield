...
export class FormErrorDisplayDirective implements OnInit, OnDestroy {
	componentRef?: ComponentRef<FormControlErrorMessageComponent | null>;
	...
	private insertErrorComponent(): void {
		if (!this.componentRef) {
			...
			this.componentRef = this.vcr.createComponent(FormControlErrorMessageComponent);
